...
git clone --branch 0.1.1 https://github.com/keptn/servicenow-service.git --single-branch
...
git clone --branch 0.1.2 https://github.com/keptn/pitometer-service.git --single-branch
